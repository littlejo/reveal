...
Mais automatiser les tests, c’est pas suffisant. Encore faut-il pouvoir déployer toute l’infra à la volée.
...
[NOTE.speaker]
====
Pour ça il nous faut aussi un outil pour gérer **l’infrastructure elle-même** :
